            ...
            <div
                ...
                <div class="lg:col-span-3 w-full lg:sticky top-0 text-center">
                    ...
                    <div class="px-4 py-10 rounded-lg shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative">
                        <img src="https://autosoukbackend.gethorcrm.com/storage/AdvertisementImages/AdvertisementImages_3d5af4if6o6p7irqbesqkbfziy_1718096542.jpg"
                            alt="Product" class="w-3/4 rounded object-cover mx-auto" />
                ...
                <div class="lg:col-span-2">
                    <h2 class="text-2xl font-extrabold text-gray-800">Honda Vezel 2015</h2>
                    ...
                    <div class="flex flex-wrap gap-4 mt-8">
                        <p class="text-gray-800 text-3xl font-bold">OMR 5000</p>
                        <!-- <p class="text-gray-400 text-base"><strike>$1500</strike> <span class="text-sm ml-1">Tax
                                included</span></p> -->
                    </div>
                    ...
                    <!-- <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-3 mt-4">
                            <button type="button"
                                class="w-10 h-10 bg-black border-2 border-white hover:border-gray-800 rounded-full shrink-0 transition-all"></button>
                            <button type="button"
                                class="w-10 h-10 bg-gray-300 border-2 border-white hover:border-gray-800 rounded-full shrink-0 transition-all"></button>
                            <button type="button"
                                class="w-10 h-10 bg-gray-100 border-2 border-white hover:border-gray-800 rounded-full shrink-0 transition-all"></button>
                            <button type="button"
                                class="w-10 h-10 bg-blue-400 border-2 border-white hover:border-gray-800 rounded-full shrink-0 transition-all"></button>
                        </div>
                    </div> -->

                    <div class="flex flex-wrap gap-4 mt-8">
                        <button type="button"
                            class="min-w-[200px] px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded">Approved
                            </button>
                        <button type="button"
