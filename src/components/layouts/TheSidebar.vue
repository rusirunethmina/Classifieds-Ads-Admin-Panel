<template>
  <aside class="hidden w-64 bg-gray-800 sm:block">
    <div class="py-3 text-2xl uppercase text-center tracking-widest bg-gray-900 border-b-2 border-gray-800 mb-8">
      <router-link to="/dashboard" class="text-white">AUTOSOUK</router-link>
    </div>
    ...
    <nav class="text-sm text-gray-300">
      <ul class="flex flex-col">
        ...
        <li class="px-4 py-2 text-xs uppercase tracking-wider text-gray-500 font-bold">Ads</li>
              ...
              <ul>
                <li>
                  <!-- <Disclosure v-slot="{ open }" :default-open="isUserActive">
                    <DisclosureButton class="pl-8 pr-4 py-3 flex items-center w-full hover:bg-gray-700"
                      :class="open ? 'bg-gray-700' : ''">
        ...
        <li class="px-4 py-2 mt-2 text-xs uppercase tracking-wider text-gray-500 font-bold">Users</li>
